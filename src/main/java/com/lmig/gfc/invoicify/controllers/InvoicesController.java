...
public class InvoicesController {
	...
	public ModelAndView chooseClient() {
		...
		// Get all the clients, aka company, and add them to the model and view with the key "clients"
	...
	public ModelAndView createInvoice(@PathVariable Long clientId) {
		...
		List<BillingRecord> clientRecords = billingRecordRepo.findByClientIdAndInvoiceLineItemIsNull(clientId);
	...
	public String createInvoice(Invoice invoice, @PathVariable Long clientId, long[] recordIds, Authentication auth) {
		...
		List<BillingRecord> clientRecords = billingRecordRepo.findByIdIn(recordIds);
		// TODO: HERES WHERE I STOPPED
		...
		for (BillingRecord record : clientRecords) {
		...
		invoice.setInvoiceLineItem(invoiceLineItems);
